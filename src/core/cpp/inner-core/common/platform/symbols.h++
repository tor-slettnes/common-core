...
#define TYPE_NAME_FULL(entity) ::cc::platform::symbols->cpp_demangle(typeid(entity).name(), false)
#define TYPE_NAME_BASE(entity) ::cc::platform::symbols->cpp_demangle(typeid(entity).name(), true)
