...
namespace cc::grpc
{
    ...
    {
        ::cc::io::proto::decode(this->details(), this);
    }
    ...
    Status::Status(const cc::protobuf::status::Event &details)
        : Event(
              details.text(),
              ::cc::io::proto::decoded<status::Domain>(details.domain()),
              details.origin(),
              details.code(),
              details.symbol(),
              ::cc::io::proto::decoded<status::Level>(details.level()),
              ::cc::io::proto::decoded<status::Flow>(details.flow()),
              ::cc::io::proto::decoded<dt::TimePoint>(details.timestamp()),
              ::cc::io::proto::decoded<types::KeyValueMap>(details.attributes())),
          ::grpc::Status(
    ...
    Status::Status(::grpc::StatusCode status_code,
        ...
        : Event(text, domain, origin, code, symbol, level, flow, timepoint, attributes),
          ::grpc::Status(
              status_code,
              text,
              ::cc::io::proto::encoded<cc::protobuf::status::Event>(
    ...
    cc::protobuf::status::Event Status::details() const noexcept
    {
        cc::protobuf::status::Event msg;
