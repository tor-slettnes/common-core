...
namespace cc::python
{
    ...
    class SimpleObject : public core::types::Streamable
    {
    public:
    ...
    public:
        ...
        core::types::Value as_value() const;
        ...
        std::optional<core::types::complex> as_complex() const;
        ...
        std::optional<core::types::ByteVector> as_bytevector() const;
        ...
        std::optional<core::types::ValueList> as_valuelist() const;
        ...
        std::optional<core::types::TaggedValueList> as_tvlist() const;
