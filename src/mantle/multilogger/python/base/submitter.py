...
#===============================================================================
## @file submitter.py
## @brief Python log handler that submits messages to MultiLogger
...
from ..protobuf import Loggable, Message, Data

class Submitter (logging.Handler):
    '''
    Log handler that submits messages to MultiLogger
    '''
