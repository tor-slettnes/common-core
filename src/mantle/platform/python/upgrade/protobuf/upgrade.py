...
### Upgrade modules
from ...vfs.protobuf import Path as VFSPath, VFSPathInput, encodePath, decodePath
from .upgrade_types_pb2 import PackageSource, UpgradeState

#===============================================================================
## Annotation types

UpgradeState = native_enum_from_proto(UpgradeState)
SourceType = PackageSource | VFSPathInput | str
