...
VFSPathInput = str | Path
VFSPathInputs = VFSPathInput | Sequence[VFSPathInput]

#===============================================================================
## Methods

def encodePath(vfspath: VFSPathInput) -> Path:
    '''
    Encode a VFS path
...
def encodePaths(vfspaths: VFSPathInputs) -> list[Path]:
    '''
...
def decodeFileInfo(stats: FileInfo) -> FileStats:
    try:
        path_type = PathType(stats.type)
    except ValueError:
...
def pathRequest(path: VFSPathInput|None = None,
                sources: VFSPathInputs|None = None,
                force: bool = False,
...
def locateRequest(root: VFSPathInput,
    ...
    return LocateRequest(
        ...
        filename_masks    = filename_masks,
        attribute_filters = encodeTaggedValueList(attribute_filters),
        with_attributes   = with_attributes,
        include_hidden    = include_hidden,
        ignore_case       = ignore_case)

def attributeRequest(vfspath: VFSPathInput,
