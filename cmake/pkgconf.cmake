...
function(add_external_dependency TARGET SUITE)
  ...
  if(arg_INCLUDE_DIRS)
    message(STATUS "Adding target ${TARGET} include directories: ${_include_dirs}")
    target_include_directories("${TARGET}" SYSTEM PUBLIC ${_include_dirs})
  endif()

  if(arg_LIBRARY_DIRS)
    message(STATUS "Adding target ${TARGET} link directories: ${_link_dirs}")
    target_link_directories("${TARGET}" PUBLIC ${_link_dirs})
  endif()

  if(arg_LIBRARIES)
    message(STATUS "Adding target ${TARGET} libraries: ${_libs}")
